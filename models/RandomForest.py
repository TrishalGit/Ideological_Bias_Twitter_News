...
for i in range(len(train_filenames)):
    ...
    for j in range(len(test_filenames)):
        ...
        print('Random Forest Accuracy Score for ' + train_filenames[i] + ' and ' + test_filenames[j] + ' -> ',accuracy_score(predicted, test_labels[j])*100)
        print('Random Forest F1 Score for ' + train_filenames[i] + ' and ' + test_filenames[j] + ' -> ', f1_score(predicted, test_labels[j], pos_label="politics")*100)

...
Original file is located at
    https://colab.research.google.com/drive/1qcWAqlkD__aHYmYBGwoI0rZ0C8UnuG2q
"""

import pandas as pd
df = pd.read_csv('/content/drive/MyDrive/NewsDataset/data/train_test_split/Left_Train.csv',header=None)
...
df_test = pd.read_csv('/content/drive/MyDrive/NewsDataset/data/train_test_split/Left_Test.csv',header=None)
...
print("F1 Score -> ",f1_score(BERT_pred, y_test)*100)
...
df_test_R = pd.read_csv('/content/drive/MyDrive/NewsDataset/data/train_test_split/Right_Test.csv',header=None)
df_test_R
